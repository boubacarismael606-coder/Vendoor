...
# --- TABLES (noms originaux conservés : "user" et "post") ---
...
def edit_post(post_id):
    ...
    if request.method == 'POST':
        ...
        post.whatsapp = request.form.get('whatsapp', post.whatsapp)
...
def admin_dashboard():
    ...
    for u in recent_users:
        u.is_online = u.last_seen and u.last_seen >= online_threshold
        ...
        'posts': [
            {
                ...
                'price': p.price, 'category': p.category, 'type': p.type,
                'image': p.image, 'promo': p.promo,
